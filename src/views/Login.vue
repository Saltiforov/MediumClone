<template>
  <div class="auth-page">
    <div class="container page">
      <div class="row">
        <div class="col-md-6 offset-md-3 col-xs3 col-xs-12">
...
name: "McvLogin",
  ...
  ...mapState({
    ...
    // ...mapState({
    //       currentUser: state => state.auth.currentUser, // использования мапстейта
    // isSubmitting(){
  ...
  methods: {
    onSubmit(){
      ...
      this.$store.dispatch(actionTypes.login,{
        email:this.email,
        password:this.password}).then(() =>{this.$router.push({name: 'globalFeed'})
          })
    },
  }
}
